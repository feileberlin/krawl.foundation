...
class PunkImHofInstagramScraper(BaseScraper):
    ...
    def __init__(self):
        super().__init__(
            base_url='https://www.instagram.com/punkinhof',
            venue_name='Punk im Hof'
        )
    ...
    def _is_event_post(self, caption: str) -> bool:
        ...
        event_keywords = [
            'konzert', 'concert', 'live', 'show', 'gig',
            'veranstaltung', 'event', 'auftritt',
            'datum', 'einlass', 'uhr', 'uhr',
            '📅', '🎵', '🎸', '🎤', '🎶'
        ]
    ...
    def _extract_event_from_caption(self, caption: str, post) -> Optional[Dict[str, Any]]:
        """
        ...
        return {
            'title': title,
            'date': date or post.date_local.strftime('%Y-%m-%d'),  # Fallback: Post-Datum
    ...
    def scrape_with_graph_api(self, access_token: str, instagram_business_id: str) -> List[Dict[str, Any]]:
        """
