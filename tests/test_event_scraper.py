...
class TestEventManager:
    ...
    def test_compare_different_events(self, event_manager, sample_event, sample_event_updated):
    ...
    def test_merge_specific_fields(self, event_manager, sample_event, sample_event_updated):
        """Test merging only specific fields."""
        merged = event_manager.merge_events(
            sample_event,
            sample_event_updated,
            fields=['date', 'price']
        )
